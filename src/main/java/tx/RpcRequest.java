...
public class RpcRequest {
    ...
    public static Object requestRpc(String url,String username,String password,String task, RpcRequest jsonRPC2Request) {
        ...
        if(bodyStr!=null){
            ...
            if(rpcResponse.isBadResult(task))badResponse=true;
        }
